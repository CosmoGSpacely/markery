...
| `enhance` — enhance/batch subcommands | ⚠️ Partial | vtracer not installed; realesrgan not installed — Phase 9 P1 |
...
| Sub-phase | Status |
|---|---|
| P1 — vtracer install + Lanczos fallback in `upscale.py` | Not started |
